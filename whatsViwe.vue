                    ...
                    <div class="col-md-8 conversa-ativa p-0">
                        ...
                        <div class="barra-superior mb-2 p-3 d-flex align-items-center" style="margin-right: 10px;" >
                            <img :src="conversas[indiceAtivo].foto"
                                alt="Foto de perfil de {{ conversas[indiceAtivo].usuario }}" 
                                class="rounded-circle mr-2" width="40" style="margin-right: 10px;">
                            <!-- Adicionar o evento de clique ao nome -->
                            <span @click="mostraInformacoesContato">{{ conversas[indiceAtivo].usuario }}</span>
                        </div>

                        <!-- Informações do contato (serão mostradas ao clicar no nome) -->
                        <div v-if="mostraDetalhes">
                            <p><strong>Nome:</strong> {{ conversas[indiceAtivo].usuario }}</p>
...
export default {
    ...
    data() {
        return {
            ...
            indiceAtivo: 0,
            conteudoASerEnviado: "",
            mostraDetalhes: false, // Controla se as informações serão exibidas
        };
    },
    components: {
    ...
    methods: {
        // Método para alternar a exibição dos detalhes do contato
        mostraInformacoesContato() {
...
.subtitle {
    ...
    color: gray; /* cor da última mensagem, embaixo do nome */
}
</style>
